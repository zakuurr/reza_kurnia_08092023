            ...
            <div class="card-body p-4">
                <form action="/pegawai/{{ $pegawai->id }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pegawai_nama" id="pegawai_nama" class="form-control" placeholder="Nama Pegawai" value="{{ $pegawai->pegawai_nama }}">
                    </div>
                    <div class="mb-3">
                        <label for="pegawai_jabatan" class="form-label">Jabtan Pegawai</label>
                        <input type="text" name="pegawai_jabatan" id="pegawai_jabatan" class="form-control" placeholder="Jabatan Pegawai" value="{{ $pegawai->pegawai_jabatan }}">
                    </div>
                    <div class="mb-3">
                        <label for="pegawai_umur" class="form-label">Umur Pegawai</label>
                        <input type="number" name="pegawai_umur" id="pegawai_umur" class="form-control" placeholder="Umur Pegawai" value="{{ $pegawai->pegawai_umur }}">
                    </div>
                    <div class="mb-3">
